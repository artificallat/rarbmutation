...
export const t = {
  en: {
    nav: {
      ...
      asoTherapy: "N-of-1 ASO Therapy",
      simonsAsoTherapy: "Simon's ASO Therapy",
      ourStory: "Our Story",
  ...
  de: {
    nav: {
      ...
      asoTherapy: "N-of-1 ASO-Therapie",
      simonsAsoTherapy: "Simons ASO-Therapie",
      ...
      sophiaProgram: "A Cure for Sophia and Friends",
      siennaProgram: "A Cure for Sienna",
      plainLanguage: "Leicht verständlich",
