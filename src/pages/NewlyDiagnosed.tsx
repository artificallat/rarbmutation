  ...
  return (
    <>
      ...
      <section className="container-tight pb-12 space-y-5 text-foreground/85 leading-relaxed text-lg">
        ...
        <p>
          {de
            ? "Willkommen in der MCOPS12-Community. Auch wenn diese Diagnose vielleicht nicht das war, was ihr erwartet habt, werdet ihr Teil eines Netzwerks von Familien, die ähnliche Erfahrungen und Wissen teilen. Viele von uns erinnern sich noch genau an den Moment, als wir die MCOPS12-Diagnose (RARB-Genmutation) erhalten haben, und an die Fragen und Unsicherheiten, die damit einhergingen. Auch wenn das Leben jetzt eine andere Richtung nimmt als ursprünglich geplant, finden viele Familien entlang des Weges wertvolle Verbindungen und Unterstützung."
            : "Welcome to the MCOPS12 community. While this diagnosis may not be something you anticipated, you are joining a network of families who share similar experiences and knowledge. Many of us remember the moment of receiving a MCOPS12 (RARB gene mutation) diagnosis and the questions and uncertainties that came with it. Although life may now take a different direction than originally planned, many families find meaningful connections and valuable support along the way."}
        </p>
