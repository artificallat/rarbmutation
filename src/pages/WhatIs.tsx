...
export default function WhatIs({ lang }: { lang: Lang }) {
  ...
  const facts = de
    ...
    : [
        ...
        { icon: AlertCircle, text: "Most frequent RARBvariant: p.Arg387Cys (p.R387C) - found in ~30% of diagnosed individuals" },
        { icon: Brain, text: "RARB iss as a transcription factor activated by retinoic acid, a metabolite of vitamin A, and plays a crucial role in the development of the eyes, diaphragm, heart, and brain." },
